    ...
    if (projects.length === 0) {
        ...
        projectsGrid.innerHTML = projects.map(project => {
            ...
            <div class="bg-white rounded-lg shadow-md hover:shadow-lg transition-all duration-200 group relative">
                <button onclick="deleteProject(event, '${project.id}')"
                    class="absolute top-3 right-3 p-1.5 bg-red-50 hover:bg-red-100 rounded-lg transition-colors opacity-0 group-hover:opacity-100 z-10"
                    title="프로젝트 삭제">
